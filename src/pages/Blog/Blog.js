...
const Blog = () => {
    ...
    return (
        <div className='flex flex-col items-center w-[400px] md:w-full bg-gray-200 py-7 space-y-6'>

            <div className='px-4 py-3 bg-white w-[400px] md:w-[500px] rounded-2xl shadow-xl'>
